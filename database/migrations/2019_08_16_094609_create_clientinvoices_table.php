...
class CreateClientinvoicesTable extends Migration {
	...
	public function up()
	{
		Schema::create('clientinvoices', function(Blueprint $table)
		{
			$table->uuid('id')->primary('ClientInvoices_pkey');
			...
			$table->uuid('client_id')->nullable()->index('ClientInvoices_IX_Client_id');
			$table->uuid('currencydoc_id')->nullable()->index('ClientInvoices_IX_CurrencyDoc_id');
			$table->uuid('currencyerp_id')->nullable()->index('ClientInvoices_IX_CurrencyErp_id');
		});
	}
