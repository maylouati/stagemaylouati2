...
class CreateClientcreditsTable extends Migration {
	...
	public function up()
	{
		Schema::create('clientcredits', function(Blueprint $table)
		{
			$table->uuid('id')->primary('ClientCredits_pkey');
			...
			$table->uuid('client_id')->nullable()->index('ClientCredits_IX_Client_id');
			$table->uuid('currencydoc_id')->nullable()->index('ClientCredits_IX_CurrencyDoc_id');
			$table->uuid('currencyerp_id')->nullable()->index('ClientCredits_IX_CurrencyErp_id');
		});
	}
