...
class CreateSupplierrnsTable extends Migration {
	...
	public function up()
	{
		Schema::create('supplierrns', function(Blueprint $table)
		{
			$table->uuid('id')->primary('SupplierRns_pkey');
			...
			$table->uuid('currencydoc_id')->nullable()->index('SupplierRns_IX_CurrencyDoc_id');
			$table->uuid('currencyerp_id')->nullable()->index('SupplierRns_IX_CurrencyErp_id');
			$table->uuid('supplier_id')->nullable()->index('SupplierRns_IX_Supplier_id');
			$table->uuid('suppliercredit_id')->nullable()->index('SupplierRns_IX_SupplierCredit_id');
		});
	}
