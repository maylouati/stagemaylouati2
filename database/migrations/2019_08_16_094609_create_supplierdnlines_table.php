...
class CreateSupplierdnlinesTable extends Migration {
	...
	public function up()
	{
		Schema::create('supplierdnlines', function(Blueprint $table)
		{
			$table->uuid('id')->primary('SupplierDnLines_pkey');
			...
			$table->uuid('item_id')->nullable()->index('SupplierDnLines_IX_Item_id');
			$table->uuid('supplierdn_id')->index('SupplierDnLines_IX_SupplierDn_id');
			$table->uuid('supplierorderline_id')->nullable()->index('SupplierDnLines_IX_SupplierOrderLine_id');
			$table->uuid('unit_id')->nullable()->index('SupplierDnLines_IX_Unit_id');
		});
	}
