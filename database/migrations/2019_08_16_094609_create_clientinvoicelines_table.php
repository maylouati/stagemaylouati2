...
class CreateClientinvoicelinesTable extends Migration {
	...
	public function up()
	{
		Schema::create('clientinvoicelines', function(Blueprint $table)
		{
			$table->uuid('id')->primary('ClientInvoiceLines_pkey');
			...
			$table->uuid('unit_id')->nullable()->index('ClientInvoiceLines_IX_Unit_id');
			$table->uuid('item_id')->nullable()->index('ClientInvoiceLines_IX_Item_id');
			$table->uuid('clientdnline_id')->nullable()->index('ClientInvoiceLines_IX_ClientDnLine_id');
			$table->uuid('clientinvoice_id')->index('ClientInvoiceLines_IX_ClientInvoice_id');
		});
	}
	...
	{
		Schema::drop('clientinvoicelines');
	}
