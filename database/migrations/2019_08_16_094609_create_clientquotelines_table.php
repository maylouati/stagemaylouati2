...
class CreateClientquotelinesTable extends Migration {
	...
	public function up()
	{
		Schema::create('clientquotelines', function(Blueprint $table)
		{
			$table->uuid('id')->primary('ClientQuoteLines_pkey');
			...
			$table->uuid('clientquote_id')->index('ClientQuoteLines_IX_ClientQuote_id');
			$table->uuid('unit_id')->nullable()->index('ClientQuoteLines_IX_Unit_id');
			$table->uuid('item_id')->nullable()->index('ClientQuoteLines_IX_Item_id');
		});
	}
