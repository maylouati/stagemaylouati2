...
class CreateClientdnsTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->uuid('id')->primary('ClientDns_pkey');
			...
			$table->uuid('client_id')->nullable()->index('ClientDns_IX_Client_id');
			$table->uuid('currencydoc_id')->nullable()->index('ClientDns_IX_CurrencyDoc_id');
			$table->uuid('currencyerp_id')->nullable()->index('ClientDns_IX_CurrencyErp_id');
		});
	}
