...
class CreateSuppliercreditsTable extends Migration {
	...
	public function up()
	{
		Schema::create('suppliercredits', function(Blueprint $table)
		{
			$table->uuid('id')->primary('SupplierCredits_pkey');
			...
			$table->uuid('currencydoc_id')->nullable()->index('SupplierCredits_IX_CurrencyDoc_id');
			$table->uuid('currencyerp_id')->nullable()->index('SupplierCredits_IX_CurrencyErp_id');
			$table->uuid('supplier_id')->nullable()->index('SupplierCredits_IX_Supplier_id');
		});
	}
