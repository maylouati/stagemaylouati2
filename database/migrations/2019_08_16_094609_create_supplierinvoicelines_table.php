...
class CreateSupplierinvoicelinesTable extends Migration {
	...
	public function up()
	{
		Schema::create('supplierinvoicelines', function(Blueprint $table)
		{
			$table->uuid('id')->primary('SupplierInvoiceLines_pkey');
			...
			$table->uuid('item_id')->nullable()->index('SupplierInvoiceLines_IX_Item_id');
			$table->uuid('supplierdnline_id')->nullable()->index('SupplierInvoiceLines_IX_SupplierDnLine_id');
			$table->uuid('supplierinvoice_id')->index('SupplierInvoiceLines_IX_SupplierInvoice_id');
			$table->uuid('unit_id')->nullable()->index('SupplierInvoiceLines_IX_Unit_id');
		});
	}
	...
	{
		Schema::drop('supplierinvoicelines');
	}
